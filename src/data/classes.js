...
export const CLASSES = [
  ...
  },
  {
    ...
    // hpMul был нулевым, и живучести на старте тоже ноль: 150 HP против 360 у
    // Бугая. По двадцати партиям симулятора это давало до 10 смертей за 20
    // минут против нуля у Бугая — не «класс на экономику», а класс, которым
    // нельзя играть. +20% HP и очко живучести оставляют его самым хрупким,
    // но убирают смерть-спираль.
    bonus: { capsMul: 0.18, critChance: 0.02, hpMul: 0.20 },
    startStats: { str: 0, vit: 1, luck: 3 },
