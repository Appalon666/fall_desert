...
// Проценты в desc обязаны совпадать с множителями в GameState (prestigeDamageMul
// и соседи) — их сверяет тест «описания престижа совпадают с кодом». Когда
// бонусы поднимали с 0.12/0.10/0.12 до 0.20/0.20/0.15, эти строки забыли, и
// экран полтора релиза обещал вдвое меньше, чем игра давала на самом деле.
const PRESTIGE = [
  { id: 'legacy', name: 'Наследие бойца', icon: '⚔️', desc: '+20% урон клика за уровень' },
  { id: 'stash', name: 'Схрон', icon: '🎒', desc: '+20% крышек за уровень' },
  { id: 'vitality', name: 'Крепкий род', icon: '❤️', desc: '+15% макс. HP за уровень' },
